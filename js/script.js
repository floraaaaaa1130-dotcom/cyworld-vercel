    ...
    riku:
    {
        ...
        low: {
            "맑음": [
                ...
                {
                    text: "아까 시온 형이 리쿠보고 고양이 닮앗다 구로케 햇어. 왜 그랫지??", // 키워드 (답정너)
                    emotion: "shy",
                    type: "keyword",
                    answers: {
                        "귀여워서": { text: "헤헤 그쳐? 리쿠가 좀 귀엽긴 하징 ~ 알썽 인정!", emotion: "happy", score: 10 },
                        "눈이커서": { text: "오.. 눈이 예쁘다는 건가? 칭찬이니 기분이 좋다", emotion: "happy", score: 5 },
    ...
    jaehee: {
        very_low: {
            ...
            "비": [
                ...
                {
                    text: "앗.. 우산이 좀 작나봐요. 제 어깨 다 젖은 거 보이죠? 으하하!", // 선택지
                    emotion: "happy",
                    choices: [
            ...
            "벚꽃": [
                ...
                {
                    text: "사람들이 다 행복해 보여요. 저까지 기분 좋아지는 거 있죠!", // 선택지
                    emotion: "happy",
                    choices: [
